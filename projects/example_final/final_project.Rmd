...
```{r lollipop, fig.height=4, fig.width=6, message=FALSE}
...
```{r change-over-time, fig.width=10, fig.height=3, message=FALSE}
...
```{r relationships, fig.width=6, fig.height=4, message=FALSE}
