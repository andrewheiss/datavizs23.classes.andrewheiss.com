...
2. **Download** the Department of Homeland Security's annual count of people granted refugee status between 2006-2015:
   ...
   [{{< fa file-csv >}} DHS refugees, 2006-2015](/data/refugee_status.csv)
...
- [{{< fa file-pdf >}} `mini-project-2-rubric.pdf`](/files/mini-project-2-rubric.pdf)
...
**The assignment is due by 11:59 PM on Monday, July 18**.
