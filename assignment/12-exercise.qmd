...
Basically follow [the code from the example in the section named "Making your own geoencoded data"](/example.qmd12-example/#making-your-own-geoencoded-data)
:::
