...
- [**Coolors**](https://coolors.co/): Generate random palettes that look great.
...
- [**Paletteer**](https://emilhvitfeldt.github.io/paletteer/): The {paletteer} package for R includes hundreds of different palettes.
