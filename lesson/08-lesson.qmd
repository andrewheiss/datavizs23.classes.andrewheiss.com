...
For the lesson, [read through the code examples in the example](/example/08-example.qmd) to see how to make small multiples, sparklines, geofacets, and slopegraphs.
